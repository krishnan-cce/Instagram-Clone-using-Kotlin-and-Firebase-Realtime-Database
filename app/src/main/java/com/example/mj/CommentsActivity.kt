...
import com.example.mj.Adapter.CommentAdapter
...
class CommentsActivity : AppCompatActivity()
{
    ...
    private var commentList: MutableList<com.example.mj.Model.Comment>? = null
        ...
        commentsRef.addValueEventListener(object : ValueEventListener
        {
            override fun onDataChange(p0: DataSnapshot)
            {
                if (p0.exists())
                {
                    ...
                    {
                        val comment = snapshot.getValue(com.example.mj.Model.Comment::class.java)
